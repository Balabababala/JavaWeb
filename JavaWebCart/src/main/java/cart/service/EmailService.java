...
public class EmailService {
	public static void main (String[] args) {
		new EmailService().sendEmail("z1724697871@gmail.com","http://localhost:8080/JavaWebCart/");
	}
	
	// Google應用程式密碼
	// 請參考此篇 https://www.yongxin-design.com/Article/10
	// 請自行產生Google應用程式密碼
	String googleAppPassword = "vayl wifj xhgz mvtu";

	// 寄件者的電子郵件地址
	String from = "z1724697871@gmail.com";
	...
	public void sendEmail(String to, String confirmUrl) {
		...
		try {
			...
			// 設定郵件標題
			message.setSubject("會員註冊確認信 標題阿哈哈哈");

			// 設定郵件內容讓使用者點選連結（confirmUrl）進行確認
			message.setText("請點選以下連結進行確認： 內文哈哈哈\n" + confirmUrl);
